    ...
    <div class="min-h-screen py-10">
        <div class="max-w-5xl mx-auto px-4">
            <div class="mb-10 text-center">
                ...
                <h1 class="mt-4 text-3xl font-semibold text-gray-900">Cek Konfirmasi Invoice</h1>
                <p class="mt-2 text-gray-600">Masukkan nomor invoice untuk melihat status konfirmasi pembayaran.</p>
            </div>
