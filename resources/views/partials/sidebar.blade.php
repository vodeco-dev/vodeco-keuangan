{{-- Menggunakan warna latar belakang gelap untuk tampilan modern --}}
<aside class="flex h-screen flex-col w-64 bg-gray-900 text-gray-300 p-4">
  ...
  <div class="flex items-center mb-8 text-center">
    ...
    <a href="{{ route('dashboard') }}">
      <span class="text-2xl font-bold text-white text-center">Vodeco</span>
    </a>
